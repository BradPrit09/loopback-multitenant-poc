...
var commands = {
  ...
  start: function() {
    ...
    console.log(' ' + chalk.grey('Gateway will be daemonized in the actual implementation.'));
    console.log(' ' + chalk.grey('Use the "internal" tenant address to access their explorer apps.'));
  },
